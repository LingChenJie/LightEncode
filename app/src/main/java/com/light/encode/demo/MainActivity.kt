...
//        }
    ...
    private fun mac() {
        ...
        decode.fieldMap.forEach { (position, field) ->
            ...
            LogUtil.e(TAG, "dataBytes:${ByteUtil.bytes2HexString(field.dataBytes)}")
            LogUtil.e(TAG, "dataLength:${field.dataLength}")
        }
    }
    ...
    private fun test() {
        // 解包
//        val response = ""
//        val response = "003E600000010230383130222000000A800000393930303030303730373132343132383030303031303030323034303037393536313930343630333030313031"
        val response = ""//6ECD1CA2AC237363
        val decodeHexStr = response.replace(" ", "")
        val decodeBytes = ByteUtil.hexString2Bytes(decodeHexStr)
        val decodeBuilder = Iso8583.DecodeBuilder()
            .addHeaderLength(5)
